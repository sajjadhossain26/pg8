      ...
      <section className="hero min-h-[75vh] bg-gradient-to-br from-indigo-950 via-purple-900 to-primary text-white">
        <div className="hero-content text-center">
          <div className="max-w-3xl">
            <p className="badge badge-accent mb-5">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              ["Study with time blocks", Clock],
              ["Practice every day", BookOpen],
            ].map(([t, Icon]) => (
              <div key={t} className="p-8 rounded-3xl bg-slate-50 shadow">
                <Icon className="text-primary mb-4" size={36} />
                <h3 className="text-xl font-bold">{t}</h3>
                <p className="mt-2 text-gray-600">
                  Build consistency, revise lessons, and complete projects after
                  each module.
                </p>
              </div>
            ))}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {instructors.map((i) => (
            ...
            >
              ...
              />
              <h3 className="font-bold text-xl mt-4">{i.name}</h3>
